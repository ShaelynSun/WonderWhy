...
image finn  = Composite(
    (300, 600),
    (0, 0), "Create_Character/Expression/expression[expression].png",
    (0, 0), "Create_character/Costume/costume[costume].png",
    (0, 0), "Create_character/Hair/hair[hairstyle]_[hair_color].png",
    (0, 0), "Create_character/Accessories/acc[acc].png",
)
