...
label home_phone:
    ...
    "You can't believe it, go and check this Alice quickly."
    jump check_alice
    return
label check_alice:
    show cpt alice
...
# define "hc_1" = "You are really really bad."
...
label home2:
    ...
    init python:
        hc = "You are really really bad.\nqwert:Overrated...I think. \nbubu:HOW dare she? \n4.Hw..so disgusting about her look. \n5.I dnt understand the hype."
